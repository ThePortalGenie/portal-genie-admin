...
| --- | --- | --- | --- |
| `/` | Redirect | — | — |
| `/engagement/rules` | Rules list | Rules | Customer Engagement / Rules |
| `/engagement/rules/new` | Rule editor (create) | Rules | Customer Engagement / Rules / Create rule |
